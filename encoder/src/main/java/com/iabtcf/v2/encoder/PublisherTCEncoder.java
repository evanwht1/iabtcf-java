...
public class PublisherTCEncoder {
	...
	static String encode(final PublisherTC publisherTC) {
		...
		BitOutputStreamUtil.write(bs, Field.PublisherTC.PUB_PURPOSE_CONSENT, publisherTC::isPurposeConsented);
		BitOutputStreamUtil.write(bs, Field.PublisherTC.PUB_PURPOSES_LI_TRANSPARENCY, publisherTC::isPurposeLegitimateInterest);
